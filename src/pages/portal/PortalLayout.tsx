...
function getExplicitWorkspace(pathname: string): WorkspaceKey | null {
  ...
  if (pathname.startsWith('/portal/clients') || pathname.startsWith('/portal/reviews') || pathname.startsWith('/portal/portfolio') || pathname.startsWith('/portal/services') || pathname.startsWith('/portal/website-packages') || pathname.startsWith('/portal/maintenance') || pathname.startsWith('/portal/hosting') || pathname.startsWith('/portal/revenue') || pathname.startsWith('/portal/connector-applications')) return null;
  if (pathname.startsWith('/portal/website-links')) return 'owner';
  return null;
}
...
export default function PortalLayout() {
  ...
  useEffect(() => {
    if (explicitWorkspace && normalizedRoles.includes(explicitWorkspace)) {
      setActiveWorkspace(explicitWorkspace);
      return;
    }
  ...
  }, [explicitWorkspace, activeWorkspace, normalizedRoles.join('|')]);
  ...
  const navItems: NavItem[] = [
    { name: 'Dashboard', path: currentWorkspace.path, icon: LayoutDashboard, roles: 'all' },
