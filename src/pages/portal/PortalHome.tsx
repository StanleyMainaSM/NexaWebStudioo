...
export default function PortalHome() {
  ...
  const workspaceCards = [] as Array<{ key: string; title: string; description: string; icon: typeof UserCircle2; path: string }>;
