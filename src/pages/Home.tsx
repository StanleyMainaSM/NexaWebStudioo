        ...
        <div className="relative max-w-7xl mx-auto px-6 py-16 grid lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7">
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-light leading-[1.1] tracking-tight text-white mb-6">
              Do You Want a Website That <br className="hidden sm:block" />
              <span className="font-semibold italic text-accent-500">Gets You More Customers?</span>
            </h1>
            <p className="text-lg text-gray-400 max-w-xl leading-relaxed">
              Avelixa builds fast, modern, conversion-focused websites that turn
            ...
            <div className="mt-12 flex items-center gap-8">
              {[
                ...
                <div key={i} className="flex items-center gap-8">
                  {i !== 0 && <div className="w-px h-12 bg-ink-800/50" />}
                  <div>
                    <div className="font-light text-3xl text-white">{s.val}</div>
                    <div className="text-xs font-bold text-ink-600 uppercase tracking-widest mt-1">{s.label}</div>
                  </div>
                </div>
              ))}
            </div>
