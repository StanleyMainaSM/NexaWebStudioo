    ...
    try {
      const { error: submitError } = await supabase
        ...
        .insert([{
          ...
          national_id_secure: formData.nationalId, // Handled securely on server usually, but we insert directly for now
          county: formData.county,
          town: formData.town,
          referring_connector_id: formData.referringConnector || null,
        }]);
      ...
      <div className="min-h-screen bg-ink-950 flex items-center justify-center p-6 relative overflow-hidden">
        ...
        <div className="w-full max-w-md glass rounded-3xl p-8 relative z-10 text-center">
          ...
          <p className="text-gray-400 mb-8">
            Thank you for applying to become an Avelixa Connector. Our team will review your application and get back to you shortly.
          </p>
  ...
  return (
    <div className="min-h-screen bg-ink-950 py-20 px-6 relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto glass rounded-3xl p-8 md:p-12 relative z-10">
        ...
        <h2 className="text-3xl font-light text-white mb-2 text-center tracking-tight">Become a Connector</h2>
        <p className="text-gray-400 text-center mb-10 max-w-lg mx-auto">
          Join our exclusive network and earn commissions by connecting businesses with premium enterprise solutions.
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block text-xs font-bold text-ink-500 uppercase tracking-widest mb-2">Full Name</label>
              <input 
                type="text" 
                name="fullName"
            ...
            <div>
              <label className="block text-xs font-bold text-ink-500 uppercase tracking-widest mb-2">Phone Number</label>
              <input 
                type="tel" 
                name="phone"
            ...
            <div>
              <label className="block text-xs font-bold text-ink-500 uppercase tracking-widest mb-2">National ID</label>
              <input 
                type="text" 
                name="nationalId"
            ...
            <div>
              <label className="block text-xs font-bold text-ink-500 uppercase tracking-widest mb-2">County</label>
              <input 
                type="text" 
                name="county"
            ...
            <div>
              <label className="block text-xs font-bold text-ink-500 uppercase tracking-widest mb-2">Town/City</label>
              <input 
                type="text" 
                name="town"
                value={formData.town}
