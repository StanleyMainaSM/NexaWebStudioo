...
const base = {
  ...
  content: { hero: { title: 'Old title', subtitle: 'Old subtitle', cta: 'Start' }, services: { items: ['Design'] }, contact: { phone: '0700000000', email: 'hello@acme.test', whatsapp: '' } },
...
assert.deepEqual(added.sections, ['hero', 'contact', 'navbar', 'footer', 'services', 'faq']);
